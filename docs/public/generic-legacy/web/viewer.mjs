...
class AppOptions {
  ...
  static getAll(kind = null, defaultOnly = false) {
    ...
    for (const name in defaultOptions) {
      ...
      options[name] = !defaultOnly && userOptions.has(name) ? userOptions.get(name) : defaultOption.value;
    }
    return options;
  }
...
const pdfjsVersion = "4.5.109";
const pdfjsBuild = "ebb3d2712";
const AppConstants = {
